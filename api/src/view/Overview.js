...
<code class="prism language-sh">npm install <span class="token operator">--</span>save draft<span class="token operator">-</span>js react react<span class="token operator">-</span>dom
# or alternately
yarn add draft<span class="token operator">-</span>js react react<span class="token operator">-</span>dom</code><p>Draft.js uses some modern ecmascript features which are not available to IE11 and not part of create-react-app's default babel config. If you're running into problems out-of-the-box try installing a shim or polyfill alongside Draft.</p>
<code class="prism language-sh">npm install <span class="token operator">--</span>save draft<span class="token operator">-</span>js react react<span class="token operator">-</span>dom babel<span class="token operator">-</span>polyfill
# or
yarn add draft<span class="token operator">-</span>js react react<span class="token operator">-</span>dom es6<span class="token operator">-</span>shim</code><p>Learn more about <a href="/docs/advanced-topics-issues-and-pitfalls.html#polyfills">using a shim with Draft</a>.</p>
...
<code class="prism language-js"><span class="token keyword">import</span> React <span class="token keyword">from</span> <span class="token string">'react'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code><p>Because Draft.js supports unicode, you must have the following meta tag in the <code>&lt;head&gt;&lt;/head&gt;</code> block of your HTML file:</p>
<code class="prism language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">charset</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>utf-8<span class="token punctuation">"</span></span> <span class="token punctuation">/&gt;</span></span></code><p><code>Draft.css</code> should be included when rendering the editor. Learn more about <a href="/docs/advanced-topics-issues-and-pitfalls.html#missing-draft-css">why</a>.</p>
