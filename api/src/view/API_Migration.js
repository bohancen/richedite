...
<code class="prism language-undefined"><span class="token keyword">const</span> entityKey <span class="token operator">=</span> Entity<span class="token punctuation">.</span><span class="token function">create</span><span class="token punctuation">(</span>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span></code><p><strong>New Syntax</strong></p>
<code class="prism language-undefined"><span class="token keyword">const</span> contentStateWithEntity <span class="token operator">=</span> contentState<span class="token punctuation">.</span><span class="token function">createEntity</span><span class="token punctuation">(</span>
  urlType<span class="token punctuation">,</span>
  <span class="token string">'IMMUTABLE'</span><span class="token punctuation">,</span>
  <span class="token punctuation">{</span>src<span class="token punctuation">:</span> urlValue<span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">const</span> entityKey <span class="token operator">=</span> contentStateWithEntity<span class="token punctuation">.</span><span class="token function">getLastCreatedEntityKey</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code><h3 id="getting-an-entity">Getting an Entity</h3>
<p><strong>Old Syntax</strong></p>
<code class="prism language-undefined"><span class="token keyword">const</span> entityInstance <span class="token operator">=</span> Entity<span class="token punctuation">.</span><span class="token keyword">get</span><span class="token punctuation">(</span>entityKey<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token comment">// entityKey is a string key associated with that entity when it was created</span></code><p><strong>New Syntax</strong></p>
...
<span class="token comment">// entityKey is a string key associated with that entity when it was created</span></code><h3 id="decorator-strategy-arguments-change">Decorator Strategy arguments change</h3>
<p><strong>Old Syntax</strong></p>
<code class="prism language-undefined"><span class="token keyword">const</span> compositeDecorator <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">CompositeDecorator</span><span class="token punctuation">(</span><span class="token punctuation">[</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code><p><strong>New Syntax</strong></p>
<code class="prism language-undefined"><span class="token keyword">const</span> compositeDecorator <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">CompositeDecorator</span><span class="token punctuation">(</span><span class="token punctuation">[</span>
  <span class="token punctuation">{</span>
    ...
    component<span class="token punctuation">:</span> ExampleTokenComponent<span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code><p>Note that ExampleTokenComponent will receive contentState as a prop.</p>
...
<code class="prism language-undefined"><span class="token keyword">const</span> <span class="token function-variable function">mutableEntityStrategy</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span>contentBlock<span class="token punctuation">,</span> callback<span class="token punctuation">,</span> contentState<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  contentBlock<span class="token punctuation">.</span><span class="token function">findEntityRanges</span><span class="token punctuation">(</span>
    ...
    callback<span class="token punctuation">,</span>
  <span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span></code><h3 id="decorator-strategies-that-find-entities">Decorator Strategies that find Entities</h3>
<p><strong>Old Syntax</strong></p>
<code class="prism language-undefined"><span class="token keyword">function</span> <span class="token function">findLinkEntities</span><span class="token punctuation">(</span>contentBlock<span class="token punctuation">,</span> callback<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  contentBlock<span class="token punctuation">.</span><span class="token function">findEntityRanges</span><span class="token punctuation">(</span>
    <span class="token punctuation">(</span>character<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
      <span class="token keyword">const</span> entityKey <span class="token operator">=</span> character<span class="token punctuation">.</span><span class="token function">getEntity</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<code class="prism language-undefined"><span class="token keyword">function</span> <span class="token function">findLinkEntities</span><span class="token punctuation">(</span>contentBlock<span class="token punctuation">,</span> callback<span class="token punctuation">,</span> contentState<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  contentBlock<span class="token punctuation">.</span><span class="token function">findEntityRanges</span><span class="token punctuation">(</span>
    ...
    callback<span class="token punctuation">,</span>
  <span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span></code><h2 id="more-information">More Information</h2>
